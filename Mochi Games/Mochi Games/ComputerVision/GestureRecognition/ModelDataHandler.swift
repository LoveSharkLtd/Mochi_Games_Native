...
class ModelDataHandler {
  ...
  /**
   ...
   on the pixel buffer.
   */
  func runModel(onFrame pixelBuffer: CVPixelBuffer) -> Gest_Result? {
    ...
    return Gest_Result(inferenceTime: interval, inferences: topNInferences)
  }
  ...
  private func rgbDataFromBuffer(
    ...
    return Data(copyingBuffer: floats)
  }
